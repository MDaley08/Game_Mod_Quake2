...
static const char* helpString[] =
{
	...
	"Hotkeys:",
	"(fireball:F)(flaming armament:G)(heat wave:Q)(shop:T)",
	0
};
...
void HelpMenu(edict_t* ent)
{
	...
	// send the layout
	Com_sprintf(string, sizeof(string),
		"xv 0 yv -250 cstring2 \"%s\""	// main title
		"xv 0 yv -230 cstring2 \"%s\""	// about title
		"xv 20 yv -215 cstring2 \"%s\""		// about body 1
		"xv 20 yv -205 cstring2 \"%s\""		// about body 2
		"xv 20 yv -195 cstring2 \"%s\""		// about body 3
		"xv 0 yv -180 cstring2 \"%s\""		// spells title
		"xv	22 yv -165 cstring2 \"%s\""		// fireball
		"xv 25 yv -150 cstring2 \"%s\""		// flame shield 1
		...
		helpString[3],	// about body 2
		helpString[4],	// about body 3
		helpString[5],	// about body 4
		helpString[6],	// objective title
...
==================
*/
void Cmd_Help_Menu_f(edict_t* ent)
{
	ent->client->showhelp = true;
	ent->client->pers.helpchanged = 0;
	HelpMenu(ent);
